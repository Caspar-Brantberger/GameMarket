...
export default async function ListingPageDetails({
    ...
    return (
        ...
        <div className="container mx-auto p-4">
            ...
            <img src={listing.imageUrl} alt={listing.title} className="my-4" />
            ...
            <div className="rounded-xl border border-gray-700 bg-gray-900 p-4">
                ...
                <p className="mt-2 text-gray-300">Seller: {listing.sellerName}</p>
                <p className="text-gray-300">Location: {listing.location}</p>
            </div>

            <a
    href={`mailto:${listing.sellerEmail}?subject=Interested in ${encodeURIComponent(
    listing.title
    )}`}
